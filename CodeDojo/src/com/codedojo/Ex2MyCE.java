...
public class Ex2MyCE {
    public static void main(String[] args) {
        ...
        System.out.println(String.format("Para A: %s", Arrays.toString(commonElements(array1A,array2A))));
        System.out.println(String.format("Para B: %s", Arrays.toString(commonElements(array1B,array2B))));
        System.out.println(String.format("Para C: %s", Arrays.toString(commonElements(array1C,array2C))));
    }
    ...
    public static Integer[] commonElements(int[] array1, int[] array2) {
        ...
        Integer[] resutlInteger = new Integer[result.size()];
        return result.toArray(resutlInteger);
    }
}
