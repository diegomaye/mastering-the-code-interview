package com.codeinterview.recursion;
...
public class Rec1WordSquaresBacktracking {
    ...
    protected void buildPrefixHashTable(String[] words) {
        ...
        /**
         * Para cada una de las palabras calculamos el prefix y luego agregamos la palabra a ese prfix en el hash
         * */
        for (String word : words) {//O(N) amount of words
            for (int i = 1; i < this.N; ++i) {//O(L) amount of letters per word
